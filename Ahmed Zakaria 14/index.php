...
<body>
    <h2 style="color:MidnightBlue ; text-align: center">Please Add Post</h2>
    ...
    <form method="post" enctype="multipart/form-data" action="store-post.php">
        ...
        <div>
            ...
            <select name="type" id="type">
                ...
                <option <?= $old['type'] == '1' ? 'selected' : ''; ?> value="4">Sports</option>
                <option <?= $old['type'] == '2' ? 'selected' : ''; ?> value="1">News</option>
                <option <?= $old['type'] == '3' ? 'selected' : ''; ?> value="2">Art</option>
                <option <?= $old['type'] == '4' ? 'selected' : ''; ?> value="3">Cars</option>
            </select>
        ...
        <!-- Thumbnail -->
        <div>
            <label for="main_image">Post Main Image</label>
            <input type="file" name="main_image" accept=".jpg,.png,.bmp" id="main_image"><span>Max size 1000 kb</span>
            <p class="errors"><?= @$errors['main_image']; ?></p>
        </div>

        <!-- other images -->
        <div>
            <label for="images">Post Mini Images</label>
            <input type="file" name="images[]" accept=".jpg,.png,.bmp" id="images" multiple />
            <p class="errors"><?= @$errors['images']; ?></p>
        </div>
