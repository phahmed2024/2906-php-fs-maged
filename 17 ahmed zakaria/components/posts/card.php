        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <div class="flex">
                    ...
                    <div class="post_editor">Posted by:<button><?= $post['name']; ?></button></div>
                </div>
                <div>
                    <h5>Reactions</h5>
                    <div class="reactions">
                        ...
                        <span>😥 SAD</span>
                        <span>😂 LAUGHT</span>
                        <div><?= $reactions['reaction_count']; ?></div>
            ...
            <div class="bottom">
                ...
                <div class="view-more">
                    <button class="view-more-button" type="Submit" 
                        onclick="window.location.href = 'components/comments/card.php'"><?= $comments_count; ?>
                        COMMENTS</button>
