    ...
    <div class="parent">
        <div class="card">
            <div class="logo">
                ...
                <span class="circle circle5"> <?= $post['id']; ?> </span>
                ...
                <div class="reactions">
                    ...
                    <?php if (isset($reactions))
                        foreach ($reactions as $reaction): ?>
                                ...
                                <span> <?= $reaction['type'] == "Love" ? "❤️️ LOVE" . $reaction['count'] : '' ?></span>
                                <span> <?= $reaction['type'] == "Like" ? "👍 Like" . $reaction['count'] : '' ?></span>
                                <span> <?= $reaction['type'] == "Care" ? "💌 Care" . $reaction['count'] : '' ?></span>
                                <span> <?= $reaction['type'] == "Happy" ? "😊 Happy" . $reaction['count'] : '' ?></span>
                                <span> <?= $reaction['type'] == "Sad" ? "😥 Sad" . $reaction['count'] : '' ?></span>
                                <span> <?= $reaction['type'] == "Laught" ? "😂 Laught" . $reaction['count'] : '' ?></span>
            ...
            <div class="bottom">
                ...
                <div class="view-more">
                    <a class="view-more-button" type="Submit"
                        href="/comments.php?post_id=<?= $post['id']; ?>"><?= $comments_count; ?>
                        COMMENTS</a>
